% POET.m carries out POET computation routine, introduced in
%   
...
% ad: defaults to 1, which performs adaptive thresholding. It should be set
% to 0 if constant thresholding is desired.
% hard: defaults to 1, which performs hard thresholding. It should be set
% to 0 if soft thresholding is desired.
